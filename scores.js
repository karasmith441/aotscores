function scoreboard(){
	...
	setTeamScores("Exoplanet Specterscopy", [5,4,4,4,7,280]);
	setTeamScores("Jupiter & Io",        	[2,4,4,3,4,-100]);
	setTeamScores("Nasa Hole",        	[2,0,4,0,0,"-0"]);
	setTeamScores("Nom Nom",        	[1,5,5,3,3,-200]);
	setTeamScores("Not Astronomers",        [2,4,4,3,5,-210]);
	setTeamScores("Roub'd",        		[3,4,3,2,5,-50]);
